              ...
              <div className="favoritos-grid">
                {favoritos.map((filme) => (
                  <div key={filme.id} className="favorito-item">
                    ...
                    />
                    <p>{filme.title}</p>
                    <button onClick={() => removeFavorite(filme.id)}>Remover dos Favoritos</button>
                  </div>
                ))}
              </div>
            ) : (
            ...
            <div className="avaliacoes-grid">
              {avaliacoes.map((avaliacao, index) => (
                <div key={index} className="avaliacao-item">
                  <img
                    src={`https://image.tmdb.org/t/p/w200${avaliacao.poster_path}`}  // Adicione esta linha
                    alt={`Poster de ${avaliacao.movieTitle}`}
                  />
